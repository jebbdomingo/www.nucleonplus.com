        ...
        <form action="" method="get" class="-koowa-grid">
            <div class="scopebar">
                ...
                <div class="scopebar-search">
                    <?php echo $this->helper('grid.search', array('submit_on_clear' => true, 'placeholder' => 'Employee\'s Name')) ?>
                </div>
            </div>
            <div class="nucleonplus_table_container">
                <table class="table table-striped footable">
                    <thead>
                        <tr>
                            ...
                            <th class="nucleonplus_table__title_field">
                                <?php echo $this->helper('grid.sort', array('column' => 'id', 'title' => 'Employee ID')); ?>
                            </th>
                            <th>
                                <?php echo $this->helper('grid.sort', array('column' => 'name', 'title' => 'Name')); ?>
                            </th>
                            <th>
                                <?php echo $this->helper('grid.sort', array('column' => 'email', 'title' => 'Email')); ?>
                            </th>
                            <th>
                                <?php echo $this->helper('grid.sort', array('column' => 'DepartmentRef', 'title' => 'Store')); ?>
                            </th>
                            <th>
                                <?php echo $this->helper('grid.sort', array('column' => 'status', 'title' => 'Status')); ?>
                            </th>
                            <th>
                                <?php echo $this->helper('grid.sort', array('column' => 'created_on', 'title' => 'Date Hired')); ?>
                            </th>
                            <th>
                                Note
                            </th>
                    ...
                    <tbody>
                        <?php if (count($employeeaccounts)): ?>
                            <?php echo $this->import('default_employees.html', ['employeeaccounts' => $employeeaccounts]) ?>
                        <?php else: ?>
                            <tr>
